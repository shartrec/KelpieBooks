    ...
    html! {
        <div class="modal-overlay" onclick={on_cancel.clone()}>
            <div class="modal-content" onclick={|e: MouseEvent| e.stop_propagation()}>
                <h2>{ i18n.t("reversal-confirm-title") }</h2>
                ...
                <div class="form-group">
                    <label for="reversal-description">{ i18n.t("reversal-confirm-reversal-description") }</label>
                    <input
                ...
                <div class="form-actions">
                    ...
                    <button type="button" onclick={on_confirm_reverse} class="button-danger">{ i18n.t("reversal-confirm-button") }</button>
                </div>
            </div>
        </div>
    }
