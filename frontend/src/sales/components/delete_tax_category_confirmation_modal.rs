...
pub struct DeleteTaxCategoryConfirmationModalProps {
    pub tax_category: TaxCategory,
    pub on_close: Callback<()>,
    pub on_confirm: Callback<()>,
}

#[function_component(DeleteTaxCategoryConfirmationModal)]
pub fn delete_tax_category_confirmation_modal(props: &DeleteTaxCategoryConfirmationModalProps) -> Html {
    ...
    let on_confirm = {
        ...
        let tax_category_id = props.tax_category.id;
    ...
    html! {
        <div class="modal-overlay" onclick={on_cancel.clone()}>
            <div class="modal-content" onclick={|e: MouseEvent| e.stop_propagation()}>
                <h2>{ i18n.t("tax-category-delete-title") }</h2>
                <p>{ i18n.t_args("tax-category-delete-confirm-message", &fluent_args!["name" => props.tax_category.name.clone()]) }</p>
